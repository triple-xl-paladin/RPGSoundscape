...
public class DBHandler
{
   ...
   * @return A Cursor object containing the results of the SQL query
   */
  public Cursor executeQuery(String table, String [] cols, String selection, String [] selectionArgs,
  ...
  private <T> ContentValues addContent(ContentValues vals, String[] cols, T[] values)
  {
    ...
    {
      l("insertQuery(): Array lengths are the same. r_cols="
          + String.valueOf(cols.length) + " r_values=" + String.valueOf(values.length));
    ...
    {
      if(cols != null)
        l("addContent():: The two arrays are of different lengths! r_cols="
            + String.valueOf(cols.length) + " r_values=" + String.valueOf(values.length));
      else
